...
\begin{figure}[H]
  \centering
  \vspace*{-1.22cm}
  \subfloat{\includegraphics[width=0.2\textwidth]{images/logo/ods.png}\label{fig:f1}}
  \hfill
  \subfloat{\includegraphics[width=0.25\textwidth]{images/logo/tub.png}\label{fig:f2}}
\end{figure}
	\begin{center}
	\vspace{1cm}
		\Huge
